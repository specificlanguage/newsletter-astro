...
<div className="flex justify-center">
  ![](https://i.imgur.com/P5mKNEh.png)
</div>

<ColoredBlock color="bg-neutral-200 text-neutral-800">
  <div className="text-neutral-800">
    Ønyx Netherite opens its doors in Pavia with huge discounts only this week!

    Why Choose Ønyx Netherite?
    Bulk prices for non-bulk purchases - Can you not afford to buy 10 netherite items to get better prices? Worry no longer because here we offer you bulk-like prices for every item you purchase.
    Transparency - You can see the repair level of all our products before purchasing them.

    What's in Stock?  (prices are this week only)
    - Pickaxes: Plain (25d), God fortune (79d), God silk touch (80d)
    - Armor: Full god prot (378d), Mid god prot (238d)
    - Swords: God sword (120d)
    - Shovels: Fortune (78d), Silk touch(79d)
    - Axes: Coming soon!

    Other repairs: armor, swords, shovels and axes repairs coming soon!
  </div>
</ColoredBlock>
